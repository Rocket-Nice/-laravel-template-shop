      ...
      <div id="tab-1-content" role="tabpanel">
        <div class="sm:w-[50%]">
          <div class="form-group">
            ...
            <x-text-input type="text" name="title" id="category-title" value="{{ old('title') }}" class="mt-1 block w-full" required />
          </div>
          <div class="form-group">
            <x-input-label for="category-description" :value="__('Описание')" />
            <x-textarea name="description" id="category-description" class="mt-1 block w-full"></x-textarea>
          </div>

          <div class="form-group">
            <x-input-label for="category-order" :value="__('Порядок сортировки')" />
            <x-text-input type="text" name="order" id="category-order" value="{{ old('order') }}" class="mt-1 block w-full" />
          </div>
          <div class="form-group">
