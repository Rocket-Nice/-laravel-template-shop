<x-admin-layout>
  ...
  <form action="{{ route('admin.vouchers.store') }}" method="post">
      ...
      <div id="tab-1-content" role="tabpanel">
        <div class="sm:w-[50%]">
          <div class="form-group">
            ...
            <x-text-input type="text" name="code" id="code" value="{{ old('code') ?? getCode(7, true).'-'.getCode(2, true) }}" class="mt-1 block w-full" required />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <x-text-input type="text" name="available_from" id="available_from" value="{{ old('available_from') ?? now()->format('d.m.Y') }}" data-minDate="false" data-timepicker="0" class="mt-1 block w-full datepicker"/>
          </div>
          <div class="form-group">
          ...
          <div class="form-group flex items-center">
            <x-checkbox name="save_amount" id="save_amount" data-name="button" value="1" />
    ...
    <div class="px-3 sm:px-4 lg:px-6 py-6 flex justify-end">
      <x-primary-button>Создать сертификат</x-primary-button>
    </div>
  </form>
</x-admin-layout>
