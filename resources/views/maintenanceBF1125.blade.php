...
<head>
  ...
  <style>
    .background {
      ...
      background-image: url("{{ asset('img/bf-1125/lm-bf-1125-bg.jpg') }}");
      background-position: center center;
      background-size: cover;
    }
    @media only screen and (max-width: 767px) {
      .background {
        background-image: url("{{ asset('img/bf-1125/lm-bf-1125-bg-m.jpg') }}");
      }
    }
...
>
  ...
  <section
    class="relative z-10 w-full max-w-4xl px-3 py-2 text-center text-white flex flex-col justify-between h-[85vh] md:h-screen"
  >
    ...
    <div class="space-y-2 md:space-y-3">
      ...
      <p class="text-base uppercase md:text-2xl roboto-400">
        скидка 15%
      </p>
    </div>
    <div class="flex justify-center">
      ...
      >
        <img
          src="{{ asset('img/bf-1125/lm-bf-1125-gift.png') }}"
    ...
    <div id="timer-container" class="">
      <p class="text-base md:text-2xl roboto-300">
        Старт акции: 18 ноября в 9:00 Мск
      </p>
      <div
        id="timer"
        class="cormorant-infant-700 font-bold flex justify-center text-4xl test-[40px] md:text-5xl lg:text-[54px] uppercase"
      >
        <span style="display: none;"><span id="days-1"></span><span id="days-2"></span></span>
        <span style="display: none;">:</span>
        <span><span id="hours-1"></span><span id="hours-2"></span></span>
        <span>:</span>
        <span><span id="minutes-1"></span><span id="minutes-2"></span></span>
        <span>:</span>
        <span><span id="seconds-1"></span><span id="seconds-2"></span></span>
      </div>

      <p class="text-base md:text-2xl roboto-300">
        <span id="days-text" style="display: none;">дней</span><span id="hours-text">часов</span>/<span id="min-text">минут</span>/<span id="sec-text">секунд</span>
      </p>
    </div>
...
<script>
  ...
  if(document.getElementById("timer")){
    ...
    var countDownDate = @json(strtotime("November 18, 2025 09:00:00") * 1000);
