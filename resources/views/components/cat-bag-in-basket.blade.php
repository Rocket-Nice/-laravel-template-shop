...
<div x-data="{
    ...
    <div x-show="total < 4000" x-cloak
        ...
        <div class="absolute -top-[4px] md:-top-5 -left-4">
            <img class="object-contain w-full h-full max-w-[127px]" src="{{ asset('img/cat-bag/cat-card-text.png') }}" alt="cat-card">
        </div>
        <div class="flex flex-col gap-[4px]">
            ...
            <p class="font-[500] text-[16px] leading-[20px] xl:flex items-center gap-1">чтобы принять участие в акции «Кот в мешке»</p>
        </div>
    </div>
    ...
    <div x-show="total >= 10000" x-cloak
        ...
        <div class="flex flex-col gap-[4px]">
            ...
            <p class="font-bold text-[16px] text-[#000000] leading-none block sm:flex items-baseline gap-[4px]">
                Доступно
                <span class="text-[32px] font-bold italic text-[#B1908E] relative -top-[5px]">3</span>
            ...
            <div class="flex items-baseline gap-[4px]">
                <p class="font-[500] text-[16px] leading-[20px] xl:flex items-center gap-1">Откройте мешочки и испытайте удачу!</p>
            </div>
