  ...
  <div class="p-4 border border-gray-200 rounded-lg bg-white">
    <div class="w-full">
      <div class="form-group lfm-box">
        <div class="product_card-style-5 relative bg-slate-100 lfm-preview rounded-md mb-2 overflow-hidden max-w-sm">
          <div class="card_fields z-10 absolute left-0 right-0 w-full"></div>
      ...
      <div class="fields">
        ...
        <div class="space-y-1 card-actions">
          ...
          <div class="relative form-group !mb-0">
            <input type="text" data-name="background" class="card-action rounded-md bg-blue-100 block border border-2 border-blue-100 p-1 h-8 max-w-xs" placeholder="Цвет фона">
          </div>
          <div class="flex space-x-1">
            <div class="relative radio-group">
              <input type="radio" value="v-pos-top" class="card-action radio-icon" data-name="vertical-align">
              <label>
            ...
            <div class="relative radio-group">
              <input type="radio" value="v-pos-bottom" class="card-action radio-icon" data-name="vertical-align">
              <label>
