  ...
  <div class="p-4 border border-gray-200 rounded-lg bg-white">
    <div class="w-full">
      <div class="form-group lfm-box">
        <div class="product_card-style-3 relative bg-slate-100 lfm-preview rounded-md mb-2 overflow-hidden max-w-sm">
      ...
      <div class="fields">
          ...
          <div class="p-4 border border-gray-200 bg-white rounded-lg dynamic-item_container">
            <div class="w-full">
              <div class="form-group">
                <x-input-label :value="__('Маленький текст')" />
                <x-textarea data-name="small-text" class="w-full"/>
              </div>
              <div class="space-y-1">
                <div class="relative form-group !mb-0">
                  <input type="text" data-name="color" data-parent="small-text" class="field-action rounded-md bg-blue-100 block border border-2 border-blue-100 p-1 h-8 max-w-xs" placeholder="#ffffff">
                </div>
                <div class="flex space-x-1">
                  <div class="relative radio-group">
                    <input type="radio" value="left" class="field-action radio-icon" data-name="text-align" data-parent="small-text">
                    <label>
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="center" class="field-action radio-icon" data-name="text-align" data-parent="small-text">
                    <label>
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="right" class="field-action radio-icon" data-name="text-align" data-parent="small-text">
                    <label>
                ...
                <div class="flex space-x-1">
                  <div class="relative radio-group">
                    <input type="radio" value="h-pos-left" class="field-action radio-icon" data-name="align" data-parent="small-text">
                    <label>
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="h-pos-center" class="field-action radio-icon" data-name="align" data-parent="small-text">
                    <label>
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="h-pos-right" class="field-action radio-icon" data-name="align" data-parent="small-text">
                    <label>
                  ...
                  <div class="relative form-group !mb-0">
                    <input type="text" data-name="align-value" data-parent="small-text" data-max-value="100" class="field-action numeric-field rounded-md bg-blue-100 block border border-2 border-blue-100 p-1 h-8 max-w-xs" placeholder="0">
                  </div>
                </div>
                <div class="flex space-x-1">
                  <div class="relative radio-group">
                    <input type="radio" value="v-pos-top" class="field-action radio-icon" data-name="vertical-align" data-parent="small-text">
                    <label>
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="v-pos-center" class="field-action radio-icon" data-name="vertical-align" data-parent="small-text">
                    <label>
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="v-pos-bottom" class="field-action radio-icon" data-name="vertical-align" data-parent="small-text">
                    <label>
                  ...
                  <div class="relative form-group !mb-0">
                    <input type="text" data-name="vertical-align-value" data-parent="small-text" data-max-value="100" class="field-action numeric-field rounded-md bg-blue-100 block border border-2 border-blue-100 p-1 h-8 max-w-xs" placeholder="0">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="field mb-3 last:mb-0 bg-slate-300 rounded-lg field-input">
          <div class="p-4 border border-gray-200 bg-white rounded-lg dynamic-item_container">
            <div class="w-full">
              <div class="form-group">
                <x-input-label :value="__('Большой текст')" />
                <x-textarea data-name="big-text" class="w-full "/>
              </div>
              <div class="space-y-1">
                <div class="relative form-group !mb-0">
                  <input type="text" data-name="color" data-parent="small-text" class="field-action rounded-md bg-blue-100 block border border-2 border-blue-100 p-1 h-8 max-w-xs" placeholder="#ffffff">
                ...
                <div class="flex space-x-1">
                  <div class="relative radio-group">
                    <input type="radio" value="left" class="field-action radio-icon" data-name="text-align" data-parent="big-text">
                    <label>
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler pointer-events-none icon-tabler-align-left" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M4 6l16 0" />
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="center" class="field-action radio-icon" data-name="text-align" data-parent="big-text">
                    <label>
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler pointer-events-none icon-tabler-align-center" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M4 6l16 0" />
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="right" class="field-action radio-icon" data-name="text-align" data-parent="big-text">
                    <label>
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler pointer-events-none icon-tabler-align-right" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M4 6l16 0" />
                ...
                <div class="flex space-x-1">
                  <div class="relative radio-group">
                    <input type="radio" value="v-pos-top" class="field-action radio-icon" data-name="vertical-align" data-parent="big-text">
                    <label>
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler pointer-events-none icon-tabler-box-align-top" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M4 9.505h16v-5a1 1 0 0 0 -1 -1h-14a1 1 0 0 0 -1 1v5z" />
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="v-pos-center" class="field-action radio-icon" data-name="vertical-align" data-parent="big-text">
                    <label>
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler pointer-events-none icon-tabler-box-align-center-vertical" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M 3.753 9.5 H 19.753 A 1 1 0 0 1 19.753 9.5 V 14.5 A 1 1 0 0 1 19.753 14.5 H 3.753 A 1 1 0 0 1 3.753 14.5 Z"/>
                  ...
                  <div class="relative radio-group">
                    <input type="radio" value="v-pos-bottom" class="field-action radio-icon" data-name="vertical-align" data-parent="big-text">
                    <label>
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler pointer-events-none icon-tabler-box-align-bottom" width="28" height="28" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        <path d="M4 14h16v5a1 1 0 0 1 -1 1h-14a1 1 0 0 1 -1 -1v-5z" />
