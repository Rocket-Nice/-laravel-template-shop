...
if (startBtn) {
  ...
  function openSack(event) {
    ...
    const prizeImageUrl = "/img/cat-bag/animation-sack/product.svg";
  ...
  function returnToSelection(openedCard) {
    ...
    const productImageUrl = openedCard.dataset.productImage || "/img/cat-bag/animation-sack/product.svg";
