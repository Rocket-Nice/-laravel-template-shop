...
//    }
  ...
  public function getStatistic(Request $request)
  {
    ...
    $orders = Order::select('id', 'data_cart', 'data->total AS total', 'data->discount AS discount',   'data->promocode AS promocode',
        'data->voucher AS voucher',
        'data->bonuses AS bonuses','data_shipping->price AS shipping_price', 'data_shipping->shipping-code AS shipping_code', 'amount')->filtered(new SafeObject($request->toArray()))->withoutTest();
